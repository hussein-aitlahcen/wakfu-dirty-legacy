...
public class SortedList<E> extends ArrayList<E>
{
    ...
    public int indexOf(final Object object) {
        final int middleIndex = this.search((E)object);
        ...
        do {
            --index;
        } while (0 <= index && this.compare(this.get(index), (E) object) == 0 && !this.get(index).equals(object));
        if (0 <= index && this.compare(this.get(index), (E) object) == 0 && this.get(index).equals(object)) {
            return index;
        }
        final int minIndex = Math.max(0, index + 1);
        index = middleIndex;
        final int size = this.size();
        while (++index < size && this.compare(this.get(index), (E) object) == 0 && !this.get(index).equals(object)) {}
        return (index < size && this.compare(this.get(index), (E) object) == 0 && this.get(index).equals(object)) ? index : (-(minIndex + 1));
    }
    
    public int firstIndexOf(final E object) {
    ...
    public int lastIndexOf(final Object object) {
        ...
        final int size = this.size();
        while (++index < size && this.compare(this.get(index), (E) object) == 0) {}
        do {
            --index;
        } while (0 <= index && this.compare(this.get(index), (E) object) == 0 && !this.get(index).equals(object));
        return (0 <= index && this.compare(this.get(index), (E) object) == 0 && this.get(index).equals(object)) ? index : -1;
    }
    ...
    public boolean removeAll(final Collection<?> collection) {
        ...
        for (final Object object : collection) {
            final int firstIndex = this.firstIndexOf((E) object);
            if (0 <= firstIndex) {
