...
public class NationProtectorBuffsAddRequest extends NationActionRequest
{
    ...
    public void execute() {
        ...
        if (nation == null) {
            NationProtectorBuffsAddRequest.m_logger.error("Impossible d'ex\u00e9cuter l'action " + this + " : la nation " + this.m_nationId + " n'existe pas");
            return;
        }
    ...
    public boolean unserialize(final ByteBuffer buffer) {
        ...
        if (remainingBytes % 4 != 0) {
            NationProtectorBuffsAddRequest.m_logger.error("Impossible de d\u00e9s\u00e9rialiser une nationActionRequest. Nombre d'octets restants non valides pour former des entiers... pas multiple de 4.");
            return false;
        }
    ...
    static {
        m_logger = Logger.getLogger(NationProtectorBuffsAddRequest.class);
