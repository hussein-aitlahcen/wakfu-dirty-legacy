...
public class NationProtectorBuffsRemoveRequest extends NationActionRequest
{
    ...
    public NationProtectorBuffsRemoveRequest() {
        super(NationActionRequestType.PROTECTOR_BUFFS_REMOVE);
    }
    ...
    static {
        ...
        FACTORY = new NationActionRequestFactory() {
            ...
            public NationActionRequest createNew() {
                return new NationProtectorBuffsRemoveRequest();
            }
        };
    }
}
