...
public final class HpLossExponentialGrowth extends HPLoss
{
    ...
    public HpLossExponentialGrowth newInstance() {
        ...
        try {
            ...
            re.m_pool = null;
            re.m_isStatic = false;
            RunningEffect.m_logger.error("Erreur lors d'un checkOut sur un HpLossExponentialGrowth : " + e.getMessage());
        }
    ...
    public void effectiveComputeValue(final RunningEffect triggerRE) {
        ...
        final double a = this.m_genericEffect.getParam(0);
        final double b = this.m_genericEffect.getParam(1);
        final double c = this.m_genericEffect.getParam(2);
