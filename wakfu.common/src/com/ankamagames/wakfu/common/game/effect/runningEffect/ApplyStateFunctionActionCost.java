...
public final class ApplyStateFunctionActionCost extends ApplyStateFunctionPaPmPw
{
    ...
    public ApplyStateFunctionActionCost newInstance() {
        ...
        try {
            ...
            re.m_pool = null;
            re.m_isStatic = false;
            RunningEffect.m_logger.error("Erreur lors d'un checkOut sur un ApplyStateFunctionActionCost : " + e.getMessage());
        }
        return re;
    }
    ...
    protected void executeOverride(final RunningEffect triggerRE, final boolean trigger) {
        ...
        if (triggerRE == null || !(triggerRE instanceof ActionCost)) {
            RunningEffect.m_logger.error("On ne peut pas utiliser cet effet avec autre chose qu'un d\u00e9clenchement li\u00e9 \u00e0 un ActionCost");
            return;
        }
