...
public abstract class WakfuRunningEffect extends RunningEffect<WakfuEffect, WakfuEffectContainer>
{
            ...
            public void unserialize(final ByteBuffer buffer, final int version) {
                ...
                switch (type) {
                    ...
                    case 25: {
                        ...
                        (WakfuRunningEffect.this).setEffectContainer(spellLevel);
                        break;
                    }
                    case 1: {
                        if ((WakfuRunningEffect.this).getEffectContainer() != null) {
                            break;
                        }
                    ...
                    case 21: {
                    	WakfuRunningEffect.this.setEffectContainer(TimelineBuffListManager.getContainerForEffect(id, (WakfuRunningEffect.this.getGenericEffect())));
                        break;
                    }
                    case 28: {
                        (WakfuRunningEffect.this).setEffectContainer(EffectContainerConstants.HAVEN_WORLD_CONTAINER);
                        break;
                    }
                    case 32: {
                        (WakfuRunningEffect.this).setEffectContainer(EffectContainerConstants.GUILD_CONTAINER);
                        break;
                    }
                    case 30: {
                        (WakfuRunningEffect.this).setEffectContainer(EffectContainerConstants.ACHIEVEMENT_BONUS_CONTAINER);
                        break;
                    }
                    case 36: {
                        ...
                        if (bonusModel != null) {
                            (WakfuRunningEffect.this).setEffectContainer(new AptitudeBonusEffectContainer(bonusModel, aptLevel));
                            break;
                        }
                        break;
                    }
                    ...
                    case 33: {
                        ...
                        (WakfuRunningEffect.this).setEffectContainer(containerBuilder.build());
                        break;
                    }
                }
            }
    ...
    public short getContainerLevel() {
        ...
        if ((this).getEffectContainer() == null) {
            return 0;
        }
        return (this).getEffectContainer().getLevel();
    }
    ...
    public boolean trigger(final byte triggerType) {
        ...
        try {
            ...
            while (allPossibleTargets.hasNext()) {
                ...
                somethingWasTriggered |= (effectUser).trigger(this.getTriggersToExecute(), this, globalTriggerType);
            }
        }
        catch (Exception e) {
    ...
    public boolean hasDurationInMs() {
        return (this).getGenericEffect() == null || (this).getGenericEffect().getEffectType() == 1;
    }
    ...
    protected Elements getSpellElement() {
        ...
        final int containerType = (this).getEffectContainer().getContainerType();
        if (containerType == 11) {
            return ((WakfuRunningEffect) (this).getEffectContainer()).getElement();
        }
        return null;
    }
    ...
    private boolean forceExecutionOnKoSpecialCases() {
        final WakfuEffectContainer container = (this).getEffectContainer();
        if (container == null) {
            return false;
        }
    ...
    private boolean createStateContainer(final long id) {
        ...
        this.m_effectContainer = state.instanceAnother(State.getLevelFromUniqueId((int)id));
        return true;
    }
    ...
    public boolean isItemEquip() {
        final WakfuEffect effect = (this).getGenericEffect();
        if (effect == null) {
            return false;
        }
        final WakfuEffectContainer effectContainer = (this).getEffectContainer();
    ...
    public boolean comeFromTransmigrableState() {
        return (this).getEffectContainer() != null && this.getEffectContainer() instanceof State && ((State) (this).getEffectContainer()).isTransmigrable();
    }
