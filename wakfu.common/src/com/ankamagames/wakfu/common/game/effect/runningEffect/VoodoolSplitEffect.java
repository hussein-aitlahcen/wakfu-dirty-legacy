...
public final class VoodoolSplitEffect extends WakfuRunningEffect
{
    ...
    public VoodoolSplitEffect newInstance() {
        ...
        try {
            ...
            re.m_pool = null;
            re.m_isStatic = false;
            RunningEffect.m_logger.error("Erreur lors d'un checkOut sur un VoodoolSplitEffect : " + e.getMessage());
        }
        return re;
    }
    ...
    protected void executeOverride(final RunningEffect linkedRE, final boolean trigger) {
        ...
        final WakfuEffect genericEffect = (WakfuEffect) linkedRE.getGenericEffect();
