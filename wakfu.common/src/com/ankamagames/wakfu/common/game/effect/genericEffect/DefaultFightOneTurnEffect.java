...
public class DefaultFightOneTurnEffect extends WakfuFightEffectImpl
{
    ...
    private DefaultFightOneTurnEffect() {
        this(false, true, WakfuStandardEffect.EMPTY_FLOAT_ARRAY);
    }
    
    private DefaultFightOneTurnEffect(final boolean isDurationInFullTurns, final boolean endsAtEndOfTurn, final float[] params) {
        super(-9, -1, AreaOfEffectEnum.POINT.newInstance(null, (short)0), WakfuStandardEffect.EMPTY_INT_ARRAY, WakfuStandardEffect.EMPTY_INT_ARRAY, WakfuStandardEffect.EMPTY_INT_ARRAY, WakfuStandardEffect.EMPTY_INT_ARRAY, WakfuStandardEffect.EMPTY_INT_ARRAY, WakfuStandardEffect.EMPTY_INT_ARRAY, WakfuStandardEffect.EMPTY_INT_ARRAY, 0L, null, false, 1, 0.0f, endsAtEndOfTurn, isDurationInFullTurns, 0, 0.0f, params, 100.0f, 0.0f, false, false, false, false, 0, Integer.MAX_VALUE, null, (short)(-1), 0.0f, (byte)(-1), false, true, true, false, null, false, false, false, false);
    }
    ...
    public static DefaultFightOneTurnEffect makeWithTurnDetails(final boolean isDurationInFullTurns, final boolean endsAtEndOfTurn) {
        return new DefaultFightOneTurnEffect(isDurationInFullTurns, endsAtEndOfTurn, WakfuStandardEffect.EMPTY_FLOAT_ARRAY);
    }
