...
public class Death extends WakfuRunningEffect
{
    ...
    public Death newInstance() {
        ...
        try {
            ...
            re.m_isStatic = false;
            re.m_pool = null;
            RunningEffect.m_logger.error("Erreur lors d'un checkOut sur un RE:Death : " + e.getMessage());
        }
    ...
    public void effectiveComputeValue(final RunningEffect triggerRE) {
        ...
        if (this.m_genericEffect.getParamsCount() >= 1) {
            this.m_raiseForbidden = (this.m_genericEffect.getParam(0, this.getContainerLevel(), RoundingMethod.LIKE_PREVIOUS_LEVEL) == 1);
        }
    }
