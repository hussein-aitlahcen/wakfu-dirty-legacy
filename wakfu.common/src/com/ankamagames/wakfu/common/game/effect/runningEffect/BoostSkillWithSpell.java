...
public class BoostSkillWithSpell extends WakfuRunningEffect
{
    ...
    protected void executeOverride(final RunningEffect linkedRE, final boolean trigger) {
        if (this.m_target != null && this.m_target.getEffectUserType() == 20 && (this).getEffectContainer() != null && ((this).getEffectContainer().getContainerType() == 11 || (this).getEffectContainer().getContainerType() == 25)) {
            final AbstractSkill skill = ((BasicCharacterInfo)this.m_target).getSkillInventory().getFirstWithReferenceId(this.m_value);
            if (skill != null) {
                skill.setLinkedLevelable((Levelable) (this).getEffectContainer());
            }
        }
    }
