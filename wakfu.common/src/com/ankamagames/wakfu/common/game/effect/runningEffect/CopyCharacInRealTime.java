...
public final class CopyCharacInRealTime extends WakfuRunningEffect
{
    ...
    public void effectiveComputeValue(final RunningEffect triggerRE) {
        ...
        if (this.m_genericEffect.getParamsCount() > 1) {
            this.m_targetCopyCaster = (this.m_genericEffect.getParam(1, this.getContainerLevel(), RoundingMethod.LIKE_PREVIOUS_LEVEL) == 1);
        }
        if (this.m_genericEffect.getParamsCount() > 2) {
            this.m_percentToCopy = this.m_genericEffect.getParam(2, this.getContainerLevel(), RoundingMethod.LIKE_PREVIOUS_LEVEL);
        }
    }
