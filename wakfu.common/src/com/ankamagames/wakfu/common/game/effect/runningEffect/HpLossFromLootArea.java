...
public final class HpLossFromLootArea extends WakfuRunningEffect
{
    ...
    protected void executeOverride(final RunningEffect triggerRE, final boolean trigger) {
        ...
        final Looter looter = (this.m_caster instanceof Looter) ? (FakeLooter) this.m_caster : new FakeLooter();
        ...
        final HPLoss hpLoss = HPLoss.checkOut(this.m_context, Elements.EARTH, HPLoss.ComputeMode.CLASSIC, hpLossValue, null);
