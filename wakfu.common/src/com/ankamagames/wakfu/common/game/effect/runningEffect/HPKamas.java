...
public class HPKamas extends HPLoss
{
    ...
    public HPKamas newInstance() {
        ...
        try {
            ...
            re.m_pool = null;
            re.m_isStatic = false;
            RunningEffect.m_logger.error("Erreur lors d'un checkOut sur un HPKamas : " + e.getMessage());
        }
    ...
    public void effectiveComputeValue(final RunningEffect triggerRE) {
        ...
        if (this.m_genericEffect != null) {
            ...
            this.m_kamaPerPDVRatio = this.m_genericEffect.getParam(1, level, RoundingMethod.RANDOM);
        }
