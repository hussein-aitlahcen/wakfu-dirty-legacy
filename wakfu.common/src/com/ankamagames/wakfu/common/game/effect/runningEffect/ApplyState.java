...
public class ApplyState extends DynamicallyDefinedRunningEffect
{
    ...
    private WakfuEffect getStateRunningGenericEffect() {
        if ((this).getGenericEffect() == null) {
            return DefaultEffect.getInstance();
        }
        if ((this).getGenericEffect().isUsableInWorld()) {
            if ((this).getGenericEffect().isUsableInFight()) {
    ...
    public boolean canBeExecuted() {
        if (this.isValueComputationEnabled()) {
            ...
            if (abstractstate != null && abstractstate.getApplyCriterions() != null && !abstractstate.getApplyCriterions().isValid(this.m_caster, this.m_target, (this).getEffectContainer(), this.getContext())) {
                return false;
            }
