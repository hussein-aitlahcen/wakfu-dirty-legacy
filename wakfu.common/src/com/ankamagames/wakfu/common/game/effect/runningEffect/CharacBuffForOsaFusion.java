...
public final class CharacBuffForOsaFusion extends CharacBuff
{
    ...
    public void effectiveComputeValue(final RunningEffect triggerRE) {
        ...
        if (this.m_genericEffect.getParamsCount() == 3) {
            ...
            final boolean upperRound = this.m_genericEffect.getParam(1, this.getContainerLevel(), RoundingMethod.LIKE_PREVIOUS_LEVEL) == 1;
            final float valueCap = this.m_genericEffect.getParam(2, this.getContainerLevel(), RoundingMethod.LIKE_PREVIOUS_LEVEL);
