...
public abstract class AbstractTimeline<F extends BasicCharacterInfo> extends TurnBasedTimeline
{
    ...
    protected AbstractTimeline(@NotNull final BasicFight owner, @NotNull final TimeScoreGauges timeScoreGauges, @NotNull final InitProvider initProvider, @NotNull final FighterSortingStrategy sortingStrategy, @NotNull final TimelineNodes nodes) {
