...
//            this.m_papermapBgColor = new Color();
            ...
            buffer.getInt();//this.m_papermapBgColor.set(buffer.getInt());
            buffer.getInt();//this.m_backGroundColor.set(buffer.getInt());
            ...
            buffer.getInt();//this.m_bannerColor.set(buffer.getInt());
        ...
        public void save(final OutputBitStream stream) throws IOException {
            ...
            stream.writeInt(0);//stream.writeInt(this.m_papermapBgColor.get());
            stream.writeInt(0);//stream.writeInt(this.m_backGroundColor.get());
            if (this.m_parallax == null) {
            ...
            stream.writeInt(0);//stream.writeInt(this.m_bannerColor.get());
