...
public class SpellInventoryManager<T extends BasicCharacterInfo & BreededCharacterInfo> extends BasicSpellInventoryManager implements FieldProvider
{
    ...
    protected BreededCharacterInfo m_characterInfo;
    
    public SpellInventoryManager(final T info) {
        super();
    ...
    public boolean add(final SpellLevel spellLevel) {
        try {
            ...
            SpellInventoryManager.m_logger.error("[SPELL] Plus de place dans l'inventaire des sort pour en apprendre un nouveau");
        }
        catch (ContentAlreadyPresentException e2) {
            SpellInventoryManager.m_logger.error("[SPELL] Sort d\u00e9j\u00e0 appri et pr\u00e9sent dans l'inventaire");
        }
        return false;
    }
    ...
    static {
        m_logger = Logger.getLogger(SpellInventoryManager.class);
