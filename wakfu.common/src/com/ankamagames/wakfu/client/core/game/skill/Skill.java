...
public class Skill extends AbstractSkill<ReferenceSkill> implements FieldProvider, Comparable<Skill>
{
    ...
    public int compareTo(final Skill o) {
        return this.getReferenceSkill().getName().compareTo(o.getReferenceSkill().getName());
    }
