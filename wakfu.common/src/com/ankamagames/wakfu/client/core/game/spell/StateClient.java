...
public class StateClient extends State implements EffectFieldProvider
{
    ...
    public String getIconUrl() {
        try {
            ...
            StateClient.m_logger.error("PropertyException pendant l'acc\u00e8s \u00e0 l'url de l'icone de l'\u00e9tat " + this.getStateBaseId());
            return null;
        }
    }
    ...
    static {
        StateClient.m_logger = Logger.getLogger(StateClient.class);
