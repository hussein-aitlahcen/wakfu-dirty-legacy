...
public class DirectoryScanner implements FileScanner, SelectorScanner, ResourceFactory
{
    ...
    synchronized void ensureNonPatternSetsReady() {
    	if(includeNonPatterns == null)
    		includeNonPatterns = new HashMap<String, TokenizedPath>();
    	if(excludeNonPatterns == null)
    		excludeNonPatterns = new HashMap<String, TokenizedPath>();
