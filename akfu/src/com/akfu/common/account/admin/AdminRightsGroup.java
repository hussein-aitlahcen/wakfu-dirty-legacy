package com.akfu.common.account.admin;
...
public enum AdminRightsGroup
{
    ...
    private final ArrayList<AdminRightsEnum> m_rights;
    
    private AdminRightsGroup(final int id, final AdminRightsEnum[] rights) {
        this.m_id = id;
        this.m_rights = new ArrayList<AdminRightsEnum>(Arrays.asList(rights));
    }
    ...
    public boolean hasRight(final AdminRightsEnum right) {
        return m_rights.contains(right);
    }
