package com.akfu.common.account;

import org.apache.log4j.*;

import com.akfu.common.Community;
import com.akfu.common.account.admin.AdminRightHelper;
import com.akfu.common.database.Account;
import com.akfu.common.maths.MathHelper;
import com.akfu.common.serialization.*;
...
public class AccountInformations extends BinarSerial
{
    ...
    public AccountInformations(Account account) {
        super();
        this.m_accountData = new AccountData();
        // TODO :TEST  
        this.setAccount_id(account.id());
        this.setAccountCommunity(Community.getById(0));
        this.setAccountNickName(account.pseudo());
        //
        ...
        this.PUBLIC_INFORMATIONS = new BinarSerialPart() {
            ...
            public void serialize(final ByteBuffer buffer) {
                ...
                buffer.put(nickName);
                buffer.putInt(AccountInformations.this.m_accountCommunity.code());
            ...
            public void unserialize(final ByteBuffer buffer, final int version) {
                ...
                AccountInformations.this.m_accountCommunity = Community.getById(buffer.getInt());
